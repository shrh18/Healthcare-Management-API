...
from old_data.serializers import OldDataSerializer as TutorialSerializer
from old_data.models import OldData as Tutorial
from django.shortcuts import render
...
# @api_view(['GET', 'DELETE'])
# def get_event(request, description, title):
#     # tutorials = Tutorial.objects.filter(title=title)
#     tutorials = Tutorial.objects.filter(
#         title=title).filter(description=description)
#     if request.method == 'GET':
#         tutorials_serializer = TutorialSerializer(tutorials, many=True)
#         return JsonResponse(tutorials_serializer.data, safe=False)

...
from doctor_api.serializers import DoctorApiSerializer as TutorialSerializer
from doctor_api.models import DoctorApi as Tutorial
...
@api_view(['GET', 'DELETE'])
def get_doctor(request, doctor_name):
    # tutorials = Tutorial.objects.filter(title=title)
    tutorials = Tutorial.objects.filter(
